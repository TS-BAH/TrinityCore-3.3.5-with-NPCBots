...
('70010','zhCN','<你看见了一个憔悴的纳迦女王. 她看起来很疲惫, 虚弱不堪, 避免直视你的目光.>请-请-请不要再说话了,$B$B凡人...',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70011','zhCN','我又把头发弄乱了吗? <她梳理了一下 \"头发\">$B...不是, 我没有\'t. 那是什么问题?',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70012','zhCN','<破败的地穴领主站在你面前, 显然他失去了控制. 没有主人, 这位强大的亡灵地穴领主失去了大部分力量.>$B$B渺小生物, 你打算怎么选择? 你的血肉与其他人一样可口...',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70013','zhCN','我吞噬生者和亡者.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70101','zhCN','|cffff3300剑圣|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\\\"剑圣, 以前是燃烧之刃家族的成员, 现在是部落中的精锐战士\\\".$B$B主要属性: 敏捷.$B$B疾风步. 让剑圣隐形, 并在一段时间内移动得更快. 当剑圣攻击一个单位以打破隐身状态时, 他将造成额外的伤害.$B$B镜像. 制造剑圣幻象迷惑敌人, 并驱散剑圣的所有魔法.$B$B爆击(被动). 有 15% 的几率在他的攻击中造成致命的 x2(x3,x4) 倍的正常伤害.$B$B剑刃风暴. 给予魔法免疫并对周围所有敌人造成伤害.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70102','zhCN','|cff9900cc黑曜石毁灭者|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\\\"黑曜石毁灭者, 对魔法有着无法满足的渴望\\\".$B$B高护甲, 非常高的抵抗力, 部分免疫魔法, 随着时间的推移失去法力\\并且不受益于被动法力再生效果, 板甲, 双持魔杖, 造成暗影法术伤害, 没有物理攻击\\法术伤害加成: 50% 攻击力 +200% 智力增加魔杖伤害.$B$B吞噬魔法. 从敌人身上驱散最多 2 个魔法效果, 从盟友身上驱散最多 2 个魔法效果和最多 2 个诅咒, 并在 20 码范围内伤害召唤单位. 每次驱散效果回复 20% 法力和 5% 生命,7 秒冷却.$B$B暗影爆炸. 强化攻击, 增加飞溅伤害.$B$B吸取法力. 从随机友方单位吸取所有法力(受施法者法力限制).$B$B补充法力. 给周围 15 码范围内的团队和团队成员通电, 使其法力值达到最大值的 1%, 影响最多 10 个目标, 冷却 3 秒.$B$B再生光环. 治疗周围 15 码范围内的团队和团队成员, 使其生命值降低施法者法力上限的 2%, 最多影响 10 个目标, 冷却 3 秒.$B$B暗影护甲(被动). 恢复相当于所受伤害百分比的法力值.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70103','zhCN','|cff0000dd大魔导师|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\\\"大法师, 无法用言语来形容的暴雪亲儿子\\\".$B$B法术伤害降低 35%, 部分免疫控制效果, 布甲, 造成火/冰法术伤害, 无物理攻击, 法术能量加成: 100% 智力. 主要属性: 智力.$B$B暴风雪! 典型的暴风雪, 只是稍微强大一点, 6 秒冷却. 召唤水元素攻击大法师的敌人 1 分钟, 冷却 20 秒.$B$B光辉光环. 增加 10% 的法力上限, 大大提高 40 码范围内己方和队友的法力回复.$B$B大规模传送.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70104','zhCN','|cff9900cc恐惧魔王|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\\\"恐惧魔王, 拥有黑暗力量和精神控制力的强大恶魔\\\".$B$B高护甲, 高抵抗, 部分免疫控制效果, 所受伤害加速法术能量, 板甲, 造成近战/暗影法术伤害, 对瘫痪目标造成额外伤害, 法术能量加成: 200% 力量. 主要属性: 力量.$B$B腐蚀虫群. 派一大群蝙蝠与混乱魔法结合,对面前锥形范围的敌人造成伤害, 无法暴击, 冷却 10 秒.$B$B沉睡. 使敌方目标睡眠 60 秒, 并允许下次对该目标的物理攻击忽视护甲, 造成的直接伤害将唤醒目标, 冷却 6 秒.$B$B吸血鬼的光环. 增加 5% 的物理暴击伤害, 治疗 40 码范围内的团队和突袭成员受到近战物理攻击和腐肉群伤害的百分比(恐惧领主 100%,其他人 25%),没有威胁.$B$B召唤地狱恶魔. 召唤一个来自天空的恶魔, 恶魔对魔法有很强的抵抗力并且持续 180 秒, 180 秒的冷却时间.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70105','zhCN','|cff0000dd破法者|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\\\"破法者, 一个被训练来破坏和扭曲魔法能量的精灵战士\\\".$B$B法术伤害减少 75%, 部分免疫控制效果, 护甲降低 -30%, 板甲, 近战/奥术伤害, 法术能量加成: 200% 力量. 主要属性: 力量.$B$B魔法偷取. 从敌人身上偷取一个有益的法术并施于附近的盟友, 或者从盟友身上移除一个消极的法术并施于附近的敌人, 影响魔法和诅咒效果, 3 秒冷却.$B$B能量窃取(被动). 成功的近战攻击消耗目标的法力, 相当于造成的伤害(由法术力增加), 造成奥术伤害.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70106','zhCN','|cff9900cc黑暗游侠|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\\\"黑暗游侠, 强行起死回生的奎尔萨拉斯的前游侠\\\".$B$B法术伤害减少 35%, 不死系, 部分免疫控制效果, 皮甲/布甲, 造成物理/暗影法术伤害, 不产生威胁, 法术力量加成: 50% 智力. 主要属性: 敏捷.$B$B沉默. 使一个敌人和最多 4 个附近目标沉默 8 秒, 15 秒冷却.$B$B黑箭. 射出一支诅咒之箭, 造成 150% 武器伤害和额外的暗影伤害. 如果受影响的目标死于黑暗游侠的伤害, 黑暗仆从将从尸体中产生(最多 5 个仆从, 持续时间 80 秒, 只对人形、野兽和龙类有效). 如果目标生命低于 20%, 造成 5 倍伤害.$B$B吸取生命. 每秒吸取一个敌人的生命值, 持续 5 秒, 治疗黑暗游侠消耗生命值的 200%.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70107','zhCN','|cff9900cc死灵法师|r$b|cffdd6600-=致敬魔兽争霸III / 暗黑破坏神II=-|r$B$B受到的法术伤害降低 20%, 部分免疫控制效果, 布甲, 造成法术暗影伤害, 没有物理攻击, 法术强度加成：100% 智力. 主属性: 智力.$B$B复活亡者. 从尸体中复活两个骷髅(最多6个骷髅, 持续时间65秒, 只对人型生物、野兽和龙类有效).$B$B邪恶狂乱. 增加目标的近战攻击速度 75%, 但会不断消耗生命值. 持续4 5秒, 无法取消. 在3 0级解锁.$B$B尸体爆炸. 使一个尸体爆炸, 对周围所有敌人造成伤害, 伤害值为死亡单位最大生命值的 35% 至 75% (取决于死灵法师的等级), 不会产生威胁值. 在 40 级解锁.$B$B瘫痪. 减少目标的移动速度、近战攻击速度和总力量 50%, 持续 60 秒.在 50 级解锁.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70108','zhCN','|cff0000dd海女巫|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\"一种凶猛的有鳞海洋生物, 通常与即将到来的巨大风暴有关\".$B$B受到法术伤害减少30%, 部分免疫控制效果, 布甲, 造成物理/法术冰霜/法术风暴伤害, 攻击强度加成: 敏捷值x2, 法术强度加成: 200% 智力. 主属性: 智力.$B$B叉形闪电. 召唤闪电锥来攻击敌人. 打击 2 个目标到所有目标不等(取决于海女巫的等级), 使其眩晕 2 秒. 此伤害不会产生威胁.$B$B冰霜箭. 让箭矢充满法术冰霜能量以造成额外伤害, 使目标的移动速度、攻击速度和施法速度减缓 30% 至 70%(取决于海女巫的等级).$B$B法力护盾. 使用海巫的法力值来创建一个可吸收 100% 攻击(未减轻)伤害的护盾. 每点法力可以吸收 2 至 10 点伤害(取决于海女巫的等级).$B$B龙卷风. 召唤一个猛烈的龙卷风, 对附近的敌方单位造成伤害并减速, 有时会完全使其失去行动能力. 龙卷风在户外随着时间的推移变得越来越大, 造成的伤害和范围也会增加, 在室内则会缩小并迅速消失. 在 60 级解锁.$B$B纳迦(被动). 在水中游泳速度提高 200%, 在水中时, 伤害和闪避几率大大增加.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70109','zhCN','|cff9900cc地穴领主|r$b|cffdd6600-=致敬魔兽争霸III=-|r$B$B\"远古巨兽, 曾经是安卓-尼鲁布的国王之一, 如今是巫妖王最强大的战士之一, 成为了不死怪物\".$B$B极高的护甲值, 增加了抗性, 部分免疫控制效果, 免疫基于毒素的效果, 锁甲/板甲, 造成近战/法术暗影伤害, 法术强度加成: 200% 力量. 主要属性: 力量.$B$B穿刺. 地穴领主用他巨大的爪子猛烈地砸击地面, 在前方锥形范围内射出尖刺, 造成伤害并将敌方单位抛起, 使其陷入眩晕状态. 在 20 级解锁.$B$B尖刺外壳. 地穴领主的外骨甲增加了伤害抵抗力, 并将 15% 至 50% 的伤害反弹给近战攻击者.$B$B腐尸甲虫. 地穴领主从敌人的新鲜尸体中繁殖出一只腐肉甲虫, 用于攻击敌人. 甲虫是永久存在的, 但无法恢复生命值, 每次只能控制6只. 随着等级的提高, 地穴领主可以召唤更强大的甲虫. 在 10 级解锁$B$B蝗虫群. 亡灵领主释放一群由 20-40 只愤怒的蝗虫组成的群体(数量取决于地穴领主的等级), 它们咬嚼并撕裂附近的敌方单位, 降低它们的移动和攻击能力. 当它们啃咬敌人的肉体时, 将其转化为一种能够恢复亡灵领主生命值的物质. 在 40 级解锁.$B$B',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
...
('70659','zhCN','禁用战斗位置调整',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
...
('70662','zhCN','存入物品...',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70663','zhCN','取出物品...',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
...
('70667','zhCN','你真的愿意花这么多钱让地穴领主再次行动起来吗?',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
('70668','zhCN','我对你在当前状态下能造成多大伤害表示怀疑, 但我愿意带领你并帮助你恢复力量.',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),
